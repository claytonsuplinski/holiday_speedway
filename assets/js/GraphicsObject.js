...
GraphicsObject.prototype.get_click_pixel = function(){
	...
	var mouse_x = parseInt(this.rttFramebuffer.width * HSPEED.mouse.x / window.innerWidth);
	var mouse_y = this.rttFramebuffer.height - parseInt(this.rttFramebuffer.height * HSPEED.mouse.y / window.innerHeight);
